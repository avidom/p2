...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/cheaps.png", id:"cheaps"},
...
(lib.cheaps = function() {
	this.initialize(img.cheaps);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,164,308);
...
(lib.Symbol16copy = function(mode,startPosition,loop) {
	...
	// нарэшце
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("ABSD/IgUhnIh/AAIgUBnIg0AAIBin9IBQAAIBiH9gAg6BnIBwAAIg3kkg");
	this.shape.setTransform(81.6,4.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("ABTEhIAAhEIjdAAIAAn9IA5AAIAAHJIB7AAIAAnJIA6AAIAAHKIAnAAIAAB3g");
	this.shape_1.setTransform(49.3,8.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgbD/IAAn9IA3AAIAAH9g");
	this.shape_2.setTransform(25.2,4.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AA+D/IAAjmIh7AAIAADmIg6AAIAAn9IA6AAIAADmIB7AAIAAjmIA6AAIAAH9g");
	this.shape_3.setTransform(3.6,4.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgbD/IAAnJIheAAIAAg0IDzAAIAAA0IheAAIAAHJg");
	this.shape_4.setTransform(-25.9,4.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AA+D/IAAjaIgoAAQgiAAgUARQgSAQgBArIAABQQAAAagCAMQgCANgFALIg6AAQAHgNACgQQACgPAAgSIAAhPQgBgqAOgbQAPgcAjgJQg/gTAAhVIAAgpQAAg6AbgdQAbgeA6AAIByAAIAAH9gAgli5QgOASAAAjIAAAxQABAqASAOQAUAOAfAAIArAAIAAi9Ig3AAQgfAAgNARg");
	this.shape_5.setTransform(-55.3,4.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AA+D/IAAnJIh7AAIAAHJIg5AAIAAn9IDtAAIAAH9g");
	this.shape_6.setTransform(-85.1,4.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// нарэшце
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#4092B8").s().p("ABSD/IgUhnIh/AAIgUBnIg0AAIBin9IBQAAIBiH9gAg6BnIBwAAIg4kkg");
	this.shape_7.setTransform(83.6,6.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#4092B8").s().p("ABTEiIAAhFIjdAAIAAn+IA5AAIAAHKIB7AAIAAnKIA6AAIAAHLIAnAAIAAB4g");
	this.shape_8.setTransform(51.3,10.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#4092B8").s().p("AgbD/IAAn9IA3AAIAAH9g");
	this.shape_9.setTransform(27.2,6.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#4092B8").s().p("AA+D/IAAjmIh7AAIAADmIg6AAIAAn9IA6AAIAADmIB7AAIAAjmIA5AAIAAH9g");
	this.shape_10.setTransform(5.6,6.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#4092B8").s().p("AgbD/IAAnJIheAAIAAg0IDzAAIAAA0IheAAIAAHJg");
	this.shape_11.setTransform(-23.9,6.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#4092B8").s().p("AA+D/IAAjaIgoAAQgiAAgTAQQgUAQAAAsIAABQQAAAZgCANQgCANgFALIg6AAQAHgNACgQQABgPAAgRIAAhQQABgpAOgcQAOgbAjgKQg/gTAAhVIAAgpQAAg5AbgeQAbgeA6AAIByAAIAAH9gAgli5QgOASAAAjIAAAxQAAAqAUAOQASAOAgAAIArAAIAAi9Ig4AAQgeAAgNARg");
	this.shape_12.setTransform(-53.3,6.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#4092B8").s().p("AA+D/IAAnJIh7AAIAAHJIg5AAIAAn9IDtAAIAAH9g");
	this.shape_13.setTransform(-83.1,6.8);
...
p.nominalBounds = new cjs.Rectangle(-102.1,-36.1,204.2,81.6);
...
(lib.Symbol16 = function(mode,startPosition,loop) {
	...
	// нарэшце
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhbDfIAAm9IC3AAIAAAtIiFAAIAACZIBsAAIAAArIhsAAIAACfICFAAIAAAtg");
	this.shape.setTransform(85.5,0);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("ABJD+IAAg9IjBAAIAAm+IAxAAIAAGRIBsAAIAAmRIAyAAIAAGSIAjAAIAABpg");
	this.shape_1.setTransform(58.8,3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AifDfIAAm9IAyAAIAAGQIBWAAIAAmQIAwAAIAAGQIBVAAIAAmQIAyAAIAAG9g");
	this.shape_2.setTransform(24,0);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhKDFQgZgfAAgzIAAgwIAvAAIAAAzQAAAeANASQAMAQAbABQAZgBANgQQANgSAAgeIAAhoIhMAAIAAgrIBMAAIAAhYQAAgegNgSQgNgQgZgBQgbABgMAQQgNASAAAeIAAAkIguAAIAAghQAAgaAGgVQAGgUAMgQQAMgOATgIQATgIAYAAQAZAAATAIQATAIANAOQAMAQAGAUQAGAVAAAaIAADlQAAAzgYAfQgZAfgzAAQgyAAgYgfg");
	this.shape_3.setTransform(-7.9,0);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhiDfIAAm9IBiAAQAzAAAYAdQAYAdAAAzIAAA2QAAA1gZAaQgaAbg0AAIgsAAIAACwgAgwACIAsAAQAbAAANgMQANgNAAghIAAg8QAAgfgLgPQgMgPgaAAIgwAAg");
	this.shape_4.setTransform(-32.2,0);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("ABIDfIgShaIhvAAIgRBaIguAAIBVm9IBHAAIBVG9gAgzBbIBiAAIgwkBg");
	this.shape_5.setTransform(-59.2,0);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AA3DfIAAjJIhsAAIAADJIgzAAIAAm9IAzAAIAADJIBsAAIAAjJIAxAAIAAG9g");
	this.shape_6.setTransform(-86.7,0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// нарэшце
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#4092B8").s().p("AhbDgIAAm+IC3AAIAAAtIiFAAIAACZIBsAAIAAArIhsAAIAACfICFAAIAAAug");
	this.shape_7.setTransform(87.5,2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#4092B8").s().p("ABJD+IAAg9IjCAAIAAm+IAyAAIAAGRIBsAAIAAmRIAyAAIAAGSIAiAAIAABpg");
	this.shape_8.setTransform(60.8,5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#4092B8").s().p("AifDgIAAm+IAyAAIAAGQIBWAAIAAmQIAwAAIAAGQIBVAAIAAmQIAyAAIAAG+g");
	this.shape_9.setTransform(26,2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#4092B8").s().p("AhKDGQgZggAAgyIAAgyIAvAAIAAA0QAAAfANAQQAMARAbAAQAZAAANgRQANgQAAgfIAAhoIhMAAIAAgrIBMAAIAAhYQAAgfgNgRQgNgRgZAAQgbAAgMARQgNARAAAfIAAAkIguAAIAAghQAAgaAGgUQAGgWAMgOQAMgPATgIQATgIAYAAQAZAAATAIQATAIANAPQAMAOAGAWQAGAUAAAaIAADmQAAAygYAgQgZAegzAAQgyAAgYgeg");
	this.shape_10.setTransform(-5.9,2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#4092B8").s().p("AhiDgIAAm+IBiAAQAzgBAYAeQAYAdAAAzIAAA2QAAA1gZAaQgaAbg0AAIgsAAIAACxgAgwACIAsAAQAbAAANgMQANgOAAggIAAg7QAAgggLgOQgMgQgaAAIgwAAg");
	this.shape_11.setTransform(-30.2,2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#4092B8").s().p("ABIDgIgShbIhvAAIgRBbIguAAIBVm+IBHAAIBVG+gAgzBbIBiAAIgwkBg");
	this.shape_12.setTransform(-57.2,2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#4092B8").s().p("AA2DgIAAjKIhrAAIAADKIgzAAIAAm+IAzAAIAADJIBrAAIAAjJIAzAAIAAG+g");
	this.shape_13.setTransform(-84.7,2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-101.8,-36.1,203.7,72.3);
...
(lib.Symbol15 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.cheaps, null, new cjs.Matrix2D(1,0,0,1,-138.8,-27.4)).s().p("AiRClIhpjkIAPihIHmAAIAAHBg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-25.1,-22.6,50.3,45.2);
...
(lib.Symbol14 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.cheaps, null, new cjs.Matrix2D(1,0,0,1,-129.9,-64.3)).s().p("Aj9AFIB4ivIGDAAIAAEoIlfAtg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-25.4,-17.1,50.8,34.3);
...
(lib.Symbol13 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.cheaps, null, new cjs.Matrix2D(1,0,0,1,-97.8,-78.8)).s().p("AiSCDIBCi5IBxhgIBKAAIAoCWIiQCXg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-14.7,-15.1,29.5,30.3);
...
(lib.Symbol12 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.cheaps, null, new cjs.Matrix2D(1,0,0,1,-106.7,-26.5)).s().p("AivjWIFBgUIhNC3IBrEAIkaAeg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-17.6,-23.5,35.3,47.1);
...
(lib.Symbol11 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.cheaps, null, new cjs.Matrix2D(1,0,0,1,-84.3,-54.7)).s().p("AAIC5IheAAIhakbIDMhoICVBSIAADJIh8B6g");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-17.7,-20.3,35.5,40.6);
...
(lib.Symbol10 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.cheaps, null, new cjs.Matrix2D(1,0,0,1,-70.1,-20.7)).s().p("AjYDOIAAmcIGxAAIAADoIiNC0g");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-21.8,-20.7,43.6,41.4);
...
(lib.Symbol9 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.cheaps, null, new cjs.Matrix2D(1,0,0,1,-72.7,-86.1)).s().p("Ah7CAIAAj/ID3AAIAADrIgUAAIAAAUg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-12.4,-12.8,24.9,25.7);
...
(lib.Symbol8 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.cheaps, null, new cjs.Matrix2D(1,0,0,1,-43.9,-85.6)).s().p("AiiDFIAAmKIFFAAIAAFKIgEAAIAAA3IiPAAIAAAJg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-16.3,-19.8,32.7,39.6);
...
p.nominalBounds = new cjs.Rectangle(-102.1,-83.6,204.2,135);
...
(lib.cheaps_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.cheaps, null, new cjs.Matrix2D(1,0,0,1,-82,-200.9)).s().p("AsyQuIAA9HQCbgOCVgwQBXgbAyghQApgeAWgPQAcgQBBgZQBQgeApgMQBCgSBJgJIHJAAIAMACQAmAGBBAZIB2AtQAgAMAMAKQAKAJAJAQIAPAbIAMAbIAAepg");
	this.shape.setTransform(0,46.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer 2 copy
	this.c8 = new lib.Symbol15();
	this.c8.setTransform(22.1,-126.5);

	this.c4 = new lib.Symbol14();
	this.c4.setTransform(35.1,-80.1);

	this.c3 = new lib.Symbol13();
	this.c3.setTransform(14.8,-65.7);

	this.c6 = new lib.Symbol12();
	this.c6.setTransform(22.1,-104.3);

	this.c5 = new lib.Symbol11();
	this.c5.setTransform(-4.4,-96);

	this.c7 = new lib.Symbol10();
	this.c7.setTransform(-14.5,-122.5);

	this.c2 = new lib.Symbol9();
	this.c2.setTransform(-0.5,-73);

	this.c1 = new lib.Symbol8();
	this.c1.setTransform(-24.1,-68.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.c1},{t:this.c2},{t:this.c7},{t:this.c5},{t:this.c6},{t:this.c3},{t:this.c4},{t:this.c8}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-82,-149.1,164,303.2);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		tl.fromTo(r.blk, 0.7, {alpha:1}, {alpha:0, ease:Power0.easeNone})
		  ...
		  .from(r.cheaps, 1.0, {x:"-=450", ease:Expo.easeOut}, time2+0.70)
		  .from(r.b1, 1.5, {x:"-=450", y:"+=600", rotation:"+=40", ease:Expo.easeOut}, time2+0.70)
		  .from(r.b2, 1.5, {x:"+=350", y:"+=500", rotation:"-=40", ease:Expo.easeOut}, time2+0.70)
		  
		  .staggerFrom([r.cheaps.c1, r.cheaps.c2, r.cheaps.c3, r.cheaps.c4, r.cheaps.c5, r.cheaps.c6, r.cheaps.c7, r.cheaps.c8], 1.2, {y:0, ease:Expo.easeOut}, 0.04, time2+1.00)
		  .staggerTo([r.cheaps.c1, r.cheaps.c2, r.cheaps.c3, r.cheaps.c4, r.cheaps.c5, r.cheaps.c6, r.cheaps.c7, r.cheaps.c8], 1.2, {y:0, ease:Expo.easeIn}, 0.08, time2+2.20)
		  .staggerFrom([r.cheaps.c1, r.cheaps.c2, r.cheaps.c3, r.cheaps.c4, r.cheaps.c5, r.cheaps.c6, r.cheaps.c7, r.cheaps.c8], 2.1, {rotation:"+=120", ease:Expo.easeOut}, 0.07, time2+1.00)
		  .staggerTo([r.cheaps.c1, r.cheaps.c2, r.cheaps.c3, r.cheaps.c4, r.cheaps.c5, r.cheaps.c6, r.cheaps.c7, r.cheaps.c8], 0.7, {rotation:"-=190", ease:Expo.easeIn}, 0.08, time2+3.10)
		  .staggerFrom([r.t2.t1, r.t2.t2], 1.2, {y:0, alpha:0, ease:Expo.easeOut}, 0.10, time2+1.50)
		  
		  //3
		  .staggerTo([r.cheaps, r.t2.t1, r.t2.t2, r.b1, r.b2], 0.6, {x:"-=550", ease:Expo.easeIn}, 0.05, time3+0.00)
		  .call(glowChas2)
	...
	// t2
	this.t2 = new lib.t2();
	this.t2.setTransform(8.1,-132,1.7,1.7);

	this.timeline.addTween(cjs.Tween.get(this.t2).wait(1));

	// b1
	this.b2 = new lib.bot2();
	this.b2.setTransform(177.1,283.9,1.2,1.2,-14);

	this.b1 = new lib.bot2();
	this.b1.setTransform(-21.3,302.5,1.2,1.2,14);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.b1},{t:this.b2}]}).wait(1));

	// cheaps
	this.cheaps = new lib.cheaps_1();
	this.cheaps.setTransform(-138.4,7.5,1.8,1.8);
...
p.nominalBounds = new cjs.Rectangle(-286,-427,712.3,1130.8);
...
p.nominalBounds = new cjs.Rectangle(194,424.4,715.9,1133.4);
